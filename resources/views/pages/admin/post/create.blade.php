                ...
                <div class="col-lg-7">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-16 font-weight-medium text-primary">Viết bài đăng</h6>
                        </div>
                        <div class="card-body">
                            <form class="load" action="{{route('post.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group formField">
                                            ...
                                            <select name="car_brand" id="car_brand" class="form-control select">
                                                @foreach ($brand_cars as $brand_car)
                                                    <option value="{{ $brand_car->id }}">{{ $brand_car->name_car_brand }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group formField">
                                            ...
                                            <select name="design_car" id="design_car" class="form-control select">
                                                @foreach ($design_cars as $design_car)
                                                    <option value="{{ $design_car->id }}">{{ $design_car->name_design_car}}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="formField">
                                            <i class="fas fa-angle-down icon"></i>
                                            <select name="district_id" id="district" class="form-control select" disabled>
                          ...
                          C104.91,91.608,107.183,91.608,108.586,90.201z" style="fill:#010002;"></path>
                                            ...
                                            <input class="input-image" name="url_picture" value="{{old('url_picture')}}" id="file" type="file" onchange="previewImage()"/>                                          
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div id="imagePreview">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group formField">
                                            <span for="exampleInputEmail1" class="status">Năm sản xuất:</span>
                                                    <i class="fas fa-angle-down icon"></i>
                                            <select name="year" class="form-control select" value="{{old('year')}}">
